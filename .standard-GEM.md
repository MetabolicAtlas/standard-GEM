...
- [ ] 🟨 _COMBINE_ archive  
The releases can contain a [COMBINE](https://doi.org/10.1186/s12859-014-0369-z) archive attached as a release artifact. Such an archive can be obtained in many ways, including directly from the git repository through a web service such as [CombineArchiveWeb](https://cat.bio.informatik.uni-rostock.de/#create).

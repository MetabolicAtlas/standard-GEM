...
The `standard-GEM` tempalte can be used. This will copy the contents of the _master_ branch into the new repository, which can be either private or public.
